...
public class NoteActivity extends AppCompatActivity {
    ...
    private void saveNote(){
        ...
        if(mEtTitle.getText().toString().trim().isEmpty() || mEtContent.getText().toString().trim().isEmpty()){
            Toast.makeText(this, "Please input title & content", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(Utilities.saveNote(this, note)){
            ...
            finish();       //go back to last activity user was inside
        }else{
            Toast.makeText(this,
                    "Can't save note. Please make sure you have enough space on your device",
        ...
        if(mLoadedNote == null){
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(this)
                    ...
                    .setMessage("You are about to delete" +
                            mEtTitle.getText().toString() + ", are you sure?")
